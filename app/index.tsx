...
export default function HomeScreen() {
  ...
  useEffect(() => {
    ...
    const unsubscribe = onSnapshot(
      ...
      async (snapshot) => {
        ...
        /*
         * Find all other users from the conversations
         */
        const otherUserIds = loadedConversations
          .map((conversation) => {
  ...
  const getOtherUserName = (
    ...
    /*
     * First try the name stored in the conversation.
     */
    ...
    /*
     * Otherwise use the name we fetched
     * from users/{uid}.
     */
    const firestoreName =
